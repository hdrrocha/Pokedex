...
import com.example.pokedex.databinding.RowLoadingErrorBinding

class PokemonItemsLoadStateAdapter(
    private val onRetry: (() -> Unit)? = null
) : LoadStateAdapter<PokemonItemsLoadStateAdapter.ViewHolder>() {
